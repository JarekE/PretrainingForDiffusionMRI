...
def data():
    ...
    dst_hcp = "/work/scratch/ecke/PretrainingForDiffusionMRI/Data"
    ...
    for s in hcp_subjects:
        ...
        src_mask = opj(src_folder, "segmentation.nii.gz")
        dst_mask = opj(dst_folder, "segmentation.nii.gz")
        ...
        new_img_original, new_aff_img_original = reslice.reslice(img, aff, zooms, new_zooms)
        ...
        new_img, new_aff_img = reslice.reslice(img, aff, zooms, new_zooms)
        new_mask, new_aff_mask = reslice.reslice(mask, aff_mask, zooms_mask, new_zooms)
